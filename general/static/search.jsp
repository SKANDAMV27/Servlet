...
<div class="container mt-5">
    ...
    <form action="birthApplication" method="get" >
        <div class="mb-3">
            <label for="name" class="form-label">Job Id Search</label>
            <input type="text" class="form-control" id="name" name="nameid" required>
        </div>
